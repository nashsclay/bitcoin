...
unsigned int ASERT(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params&);
unsigned int SimpleTargetFrontier(const CBlockIndex* pindexLast, const CBlockHeader *pblock, const Consensus::Params&);
