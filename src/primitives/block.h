...
public:
    // header
    static const uint32_t FIRST_FORK_VERSION = 9;
    uint32_t nVersion;
    ...
    bool IsProofOfStake() const
    {
        ...
        return (nVersion & VERSION_ALGO) == VERSION_POS || (nVersion < CBlockHeader::FIRST_FORK_VERSION && nNonce == 0);
    }

    bool IsProofOfWork() const
    {
        return (nVersion & VERSION_POW) || (nVersion < CBlockHeader::FIRST_FORK_VERSION && nNonce != 0);
    }
    ...
    static uint32_t GetVer(int algo)
    {
        switch (algo) {
            ...
            default:
                return CBlockHeader::FIRST_FORK_VERSION;
        }
    }
